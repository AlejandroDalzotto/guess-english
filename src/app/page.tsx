  ...
  return (
    <main className="px-6 container mx-auto grid grid-rows-10 max-h-screen min-h-screen">
      <header className="row-span-5 flex flex-col gap-y-8 items-center justify-center">
        ...
        <p className="text-lg text-center text-balance">A simple game made for those spanish natives who wants to improve their skills in english and why not have some fun.</p>
