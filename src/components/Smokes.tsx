...
export const Smoke3 = () => {
  return (
    <div
      aria-hidden
      className="-z-10 animate-fade-middle-opacity absolute top-32 left-1/3 md:right-32 bg-gradient-conic from-red-600 via-amber-400 to-transparent blur-3xl rounded-full w-40 h-[800px] rotate-45"
    ></div>
  )
}
