...
export default function GoBackButton({ backTo, label }: Props) {
  ...
  return (
    <button
      ...
      className="flex active:scale-90 hover:scale-105 transition-all gap-x-2 py-3 px-6 rounded-lg w-fit items-center select-none relative hover:bg-white/5 border border-neutral-700"
    >
